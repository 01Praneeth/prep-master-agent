...
const Register = () => {
  ...
  const validateForm = () => {
    if (!formData.name || !formData.email || !formData.password || !formData.confirmPassword || !formData.exam) {
      toast({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("userExam", formData.exam);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-6">
            ...
            <span className="text-2xl font-bold text-foreground">StudyPilot AI</span>
          </Link>
          <h1 className="text-2xl font-bold text-foreground">Create your account</h1>
          <p className="text-muted-foreground">Start your personalized learning journey today</p>
        </div>

        <Card className="study-card border-0 animate-fade-in">
          <CardHeader>
            <CardTitle>Sign up for StudyPilot AI</CardTitle>
            <CardDescription>Create your account and begin adaptive exam preparation</CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
                  ...
                  <path d="M13 0h11v11H13z" fill="#00a4ef" />
